<?php
add_action('admin_menu', 'tx_woo_slider_menu');
function tx_woo_slider_menu(){

add_menu_page('Smart Product Gallery Slider', 'Product Gallery', 'administrator', 'tx_woo_slider_settings','tx_woo_slider_settings');
}
function tx_woo_slider_settings(){ 

    if(isset($_POST['save_tx_woo_slider_settings']) && $_POST['save_tx_woo_slider_settings'] ){
...
'w_slider_resizeDuration'=>($_POST['w_slider_resizeDuration']) ? trim( sanitize_text_field($_POST['w_slider_resizeDuration'])) : 700,
     ...
     update_option('tx_woo_slider_settings',$updated_settings);
        ...
        <?php echo $update_message; ?>
               ...
               <div class="settings_section">
                 ...
                 <div class="settings_section">
                      ...
                      <div class="fields">
                         ...
                         <span class="radio_field">
                           ...
                           <input type="radio" name="slider_type[]" id="slider_type_thumbs" value="Thumbs" class="tx_woo_slider_type" <?php if($settings['w_slider_type']==='Thumbs') echo 'checked';?>/>
                          </span> 
                          <span class="radio_field">
                            <label for="slider_type_v_thumbs">Vertical Thumb Slider</label>
                           <input type="radio" name="slider_type[]" id="slider_type_v_thumbs" value="VThumbs" class="tx_woo_slider_type"  <?php if($settings['w_slider_type']==='VThumbs') echo 'checked';?>/>
                          </span>
                          <span class="radio_field">
                            <label for="slider_type_dots">Dotted Slider</label>
                           <input type="radio" name="slider_type[]" id="slider_type_dots" value="Dots" class="tx_woo_slider_type"  <?php if($settings['w_slider_type']==='Dots') echo 'checked';?>/>
                          </span>
                      </div>
                </div>
                <div class="settings_section">
                ...
                <div class="settings_section">
                 ...
                 <input type="submit" class="button button-primary" name="save_tx_woo_slider_settings" id="save_tx_woo_slider_settings" value="Save Settings"/>
             ...
             jQuery(document).ready(function($){
				 ...
				 var lightBoxSubSettingsWrapper=$('#lightbox_sub_settings');
				     ...
				     $('#w_slider_activate_lightbox').on('change',function(){
                      ...
                      $('.tx_woo_slider_type').change(function(){
